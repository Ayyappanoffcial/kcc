...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-man">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a class="" id="" href="ex.html">JOIN</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <img src="img/background2.jpg" alt="" class="img-responsive">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <!-- <img src="img/kalam logo.jpg" alt=""> -->
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="copyright">
    <p>©2024 | All right reserved by Kcc</p>
  </div>
</body>
